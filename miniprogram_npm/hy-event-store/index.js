...
__DEFINE__(1642161810895, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1642161810896,"./event-store":1642161810897}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642161810896, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1642161810897, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1642161810896,"./utils":1642161810898}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642161810898, function(require, module, exports) {
...
return __REQUIRE__(1642161810895);
})()
